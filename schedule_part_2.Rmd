...
dt <- data.frame(schedule = c("1", "2", 
                 ...
                 topics = c("Phylodynamics I", "**No class**",
                            ...
                            "**No class** (office hours 06.06 & 13.06)", "Intro to BEAST2",
...
urls <- c("slides/08-BEAST2.pdf","https://taming-the-beast.org/tutorials/Introduction-to-BEAST2/")

dt <- data.frame(schedule = c("Slides", "Exercise"),
                 topics = c("Intro to BEAST2", "Node dating using BEAST2"))
dt$schedule[1] <- paste0("[", dt$schedule[1], "](", urls[1], ")")
dt$schedule[2] <- paste0("[", dt$schedule[2], "](", urls[2], ")")
...
urls <- c("slides/08-BEAST2.pdf","exercise-BDMMP.html")

dt <- data.frame(schedule = c("Slides", "Exercise"),
                 topics = c("Phylodynamics II", "BDMM-Prime"))
dt$schedule[1] <- paste0("[", dt$schedule[1], "](", urls[1], ")")
dt$schedule[2] <- paste0("[", dt$schedule[2], "](", urls[2], ")")
...
Answers to the above questions are [available here](slides/09_Lewis_Q&A.pdf).
